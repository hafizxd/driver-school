...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="user-tab" data-toggle="pill" href="#users-tab" role="tab" aria-controls="users-tab" aria-selected="true" @if(getRole() != 2)) style="display: none;" @endif>Pengguna</a>
                </li>
                <li class="nav-item">
                    <a @if(getRole() != 2)) class="nav-link active" @else class="nav-link" @endif  id="driver-tab" data-toggle="pill" href="#drivers-tab" role="tab" aria-controls="drivers-tab" aria-selected="false">Supir</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/order" @if(getRole() != 2)) style="display: none;" @endif>Langganan</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        {{-- Content Pengguna --}}
        <div @if(getRole() != 2)) class="tab-pane fade" @else class="tab-pane fade show active" @endif  id="users-tab" role="tabpanel" aria-labelledby="users-tab">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card">
        ...
        {{-- Content Supir --}}
        <div @if(getRole() != 2)) class="tab-pane fade show active" @else class="tab-pane fade" @endif id="drivers-tab" role="tabpanel" aria-labelledby="drivers-tab">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="booking-tab" data-toggle="pill" href="#blokirSupir-tab" role="tab" aria-controls="blokirSupir-tab" aria-selected="false" @if(getRole() != 2)) style="display: none;" @endif >Blokir</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pending-tab" data-toggle="pill" href="#pendingSupir-tab" role="tab" aria-controls="pendingSupir-tab" aria-selected="false" @if(getRole() != 2)) style="display: none;" @endif >Pending</a>
                                </li>
                            </ul>
                            <br>
